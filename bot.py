...
# OYUN FUNKSİYALARI
# ... (Bütün oyun funksiyaları tam şəkildə əvvəlki koddadır)

# DÜYMƏ VƏ MESAJ HANDLERLƏRİ
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    # ... (Tam button_handler funksiyası əvvəlki koddadır)
    pass
async def handle_all_messages(update: Update, context: ContextTypes.DEFAULT_TYPE):
    # ... (Tam handle_all_messages funksiyası əvvəlki koddadır)
    pass
async def word_filter_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    # ... (Tam word_filter_handler funksiyası əvvəlki koddadır)
    pass
...
async def main() -> None:
    ...
    # ... (Bütün command və message handlerlərin əlavə edilməsi)
