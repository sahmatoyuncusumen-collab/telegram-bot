...
async def viktorina_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Son 10 sualın təkrar olunmaması üçün məntiq
    ...
    if not possible_questions: # Əgər bütün suallar verilibsə, yaddaşı təmizlə
